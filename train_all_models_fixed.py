"""
BLACK VEIL - Complete Training Pipeline (Fixed)
"""
...
class CompleteTrainer:
    ...
    def load_encode(self, dataset_name):
        ...
        if dataset_name in ['CICIDS', 'EDGE'] and len(X) > 50000:
    ...
    def train_deep_learning(self, X, y, dataset_name):
        """Train PyTorch model on GPU - FIXED"""
        ...
        # Convert to numpy arrays first (FIX)
